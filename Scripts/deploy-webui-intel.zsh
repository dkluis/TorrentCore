...
if [[ "${RESTART_AFTER_DEPLOY}" == true ]]; then
  "${TARGET_SCRIPT_DIR}/install-launch-agents.zsh" webui
  "${TARGET_SCRIPT_DIR}/ManageTorrentCoreLaunchAgents.zsh" restart webui
fi

tc_log_info "WebUI deployment complete."
