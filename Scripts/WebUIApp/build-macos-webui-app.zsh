...
"$SCRIPT_DIR/package-macos-webui-app.zsh" --publish-root "$PUBLISH_ROOT" --output-bundle "$OUTPUT_BUNDLE" --version 0.6.0 --build-number 11 --git-sha "$GIT_SHA" --built-at-utc "$BUILT_AT_UTC"
