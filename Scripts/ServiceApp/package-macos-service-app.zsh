...
usage() {
    print -r -- "Usage: package-macos-service-app.zsh --publish-root <dir> --output-bundle <TorrentCoreService.app> --git-sha <40-hex> --built-at-utc <ISO-8601> [--version 0.6.0] [--build-number 1]"
}
