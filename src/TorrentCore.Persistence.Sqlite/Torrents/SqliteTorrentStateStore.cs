    ...
    private static async Task<IReadOnlyList<TorrentSnapshot>> ReadSnapshotsAsync(SqliteCommand command, CancellationToken cancellationToken)
    {
        ...
        while (await reader.ReadAsync(cancellationToken))
        {
            results.Add(new TorrentSnapshot
            {
                ...
                State = Enum.Parse<TorrentState>(reader.GetString(5), ignoreCase: true),
                DesiredState = Enum.Parse<TorrentDesiredState>(reader.GetString(6), ignoreCase: true),
                MagnetUri = reader.GetString(7),
                InfoHash = reader.IsDBNull(8) ? null : reader.GetString(8),
                DownloadRootPath = reader.IsDBNull(9) ? null : reader.GetString(9),
                SavePath = reader.GetString(10),
                ProgressPercent = reader.GetDouble(11),
                DownloadedBytes = reader.GetInt64(12),
                UploadedBytes = reader.GetInt64(13),
                TotalBytes = reader.IsDBNull(14) ? null : reader.GetInt64(14),
                DownloadRateBytesPerSecond = reader.GetInt64(15),
                UploadRateBytesPerSecond = reader.GetInt64(16),
                TrackerCount = reader.GetInt32(17),
                ConnectedPeerCount = reader.GetInt32(18),
                AddedAtUtc = DateTimeOffset.Parse(reader.GetString(19), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind),
                CompletedAtUtc = reader.IsDBNull(20) ? null : DateTimeOffset.Parse(reader.GetString(20), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind),
                SeedingStartedAtUtc = reader.IsDBNull(21) ? null : DateTimeOffset.Parse(reader.GetString(21), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind),
                LastActivityAtUtc = reader.IsDBNull(22) ? null : DateTimeOffset.Parse(reader.GetString(22), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind),
                ErrorMessage = reader.IsDBNull(23) ? null : reader.GetString(23),
            });
        }
