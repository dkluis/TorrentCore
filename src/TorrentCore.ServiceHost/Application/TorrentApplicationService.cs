    ...
    ILogger<TorrentApplicationService> logger) : ITorrentApplicationService
{
    ...
    public async Task<EngineHostStatusDto> GetHostStatusAsync(CancellationToken cancellationToken)
    {
        ...
        return new EngineHostStatusDto
        {
            ...
            ExpressVpnRecoveryMode = runtimeSettings.ExpressVpnAutomaticRecoveryMode.ToString(),
            ExpressVpnRecoveryPhase = vpnConnection.ExpressVpnRecoveryPhase.ToString(),
            ExpressVpnConnectionState = vpnConnection.ExpressVpnConnectionState,
            ExpressVpnReconnectAttemptsUsed = vpnConnection.ExpressVpnReconnectAttemptsUsed,
            ExpressVpnReconnectAttemptsMaximum = 2,
            ExpressVpnLaunchAttemptsUsed = vpnConnection.ExpressVpnLaunchAttemptsUsed,
            ExpressVpnLaunchAttemptsMaximum = 2,
            ExpressVpnNextActionAtUtc = vpnConnection.ExpressVpnNextActionAtUtc,
            ExpressVpnLastActionAtUtc = vpnConnection.ExpressVpnLastActionAtUtc,
            ExpressVpnLastActionOutcome = vpnConnection.ExpressVpnLastActionOutcome,
            ExpressVpnRecoveryMessage = vpnConnection.ExpressVpnRecoveryMessage,
