    ...
    ILogger<TorrentApplicationService> logger) : ITorrentApplicationService
{
    public async Task<EngineHostStatusDto> GetHostStatusAsync(CancellationToken cancellationToken)
    {
        ...
        return new EngineHostStatusDto
        {
            ...
            EngineMaximumConnections = serviceOptions.Value.EngineMaximumConnections,
            EngineMaximumHalfOpenConnections = serviceOptions.Value.EngineMaximumHalfOpenConnections,
            EngineMaximumDownloadRateBytesPerSecond = serviceOptions.Value.EngineMaximumDownloadRateBytesPerSecond,
            EngineMaximumUploadRateBytesPerSecond = serviceOptions.Value.EngineMaximumUploadRateBytesPerSecond,
