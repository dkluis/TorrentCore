...
- **5C — release construction:** complete July 26, 2026. Version 0.1.0/build 1, Team ID, Arm64/macOS 26 release
  ...
  Live Service deployment and macOS client testing through Xcode passed against CA-Desktop. The refinement was then
  ...
  The metadata-admission and recovery settings were released for macOS as 0.5.0/build 9 and accepted under
  notarization submission `d6626a01-99ce-4569-8814-951caecda675`; its copied DMG passed signature, stapler-ticket,
  disk-image, Gatekeeper, and checksum verification.
